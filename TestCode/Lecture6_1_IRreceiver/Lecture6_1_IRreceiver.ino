...
#define IR_RCV_PIN      33  // lecture suggests to use pin 33 / P5.1
...
void loop() {
    ...
    if (irRX.decodeIR(&IRresults)) {
        ...
        Serial.println();
        translateIR();            // translates the IR code to the ELEG transmitter buttons
    }
}

// Downloaded from Moodle in the Project Resources section
/*
